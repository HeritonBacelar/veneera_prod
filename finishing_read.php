...
$result = mysqli_query ($conn, "SELECT * FROM finishing_protocol ORDER BY suitble_id DESC ");
    ...
    <table class="sty">
        ...
        while ($res = mysqli_fetch_assoc($result)){ 
            ...
            echo "<td> 
                        ...
                        <a class='btn btn-sm btn-danger' href='send_to_finished.php?suitble_id=$res[suitble_id]' title='send'> 
